...
<ol class="relative border-s border-gray-200 ">                  
    <li class="mb-10 ms-6">            
        ...
        <h3 class="flex items-center mb-1 text-2xl text-white font-semibold">Software Developer <span class="bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded   ms-3">Latest</span></h3>
    ...
    <li class="mb-10 ms-6">
        ...
        <h3 class="flex items-center mb-1 text-2xl font-semibold text-white dark:text-white">Data Science Intern </h3>
...
visualized using popular EDA techniques for effective decision making.</p>
    ...
    <li class="ms-6">
        ...
        <h3 class="flex items-center mb-1 text-2xl font-semibold text-white ">Python Developer </h3>
...
volatility, volume, etc.</p>
    ...
    <li class="ms-6">
        ...
        <h3 class="flex items-center mb-1 text-2xl font-semibold text-white ">Data Science Intern </h3>
...
percentage match for an individual profile with the job description. Visualized using matplotlib for efficient hiring.</p>
    ...
    <li class="ms-6">
        ...
        <h3 class="flex items-center mb-1 text-2xl font-semibold text-white">Data Intern</h3>
